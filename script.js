...
function showMeme() {
  ...
  const exists = document.getElementById("meme-image");

  const meme = exists ? exists : document.createElement("img");
  meme.id = "meme-image";
  meme.src = getRandomData("memes");
  meme.alt = "Programmer Meme Here!";
...
function showRiddle() {
  ...
  const riddle = document.getElementById('riddle-question');
  riddle.innerText = randomRiddle.question;
